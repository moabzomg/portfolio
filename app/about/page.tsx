...
export default function Page() {
  return (
    <div className="bg-gray-900 text-white">
      {/* About Me Section */}
      <section className="flex flex-col items-center py-16 px-6 min-h-screen">
        ...
        <div className="max-w-3xl mb-8">
          <p className="text-xl mb-6 tracking-wide leading-relaxed opacity-80 transform transition-all duration-500 hover:scale-105 hover:text-teal-400">
            ...
            problem-solving, and continuous improvement. I specialize in
            creating solutions that make a real-world impact, and I enjoy
            collaborating with teams to build high-quality, scalable systems.
          </p>
          ...
          <p className="text-xl mb-6 tracking-wide leading-relaxed opacity-80 transform transition-all duration-500 hover:scale-105 hover:text-teal-400">
            ...
            delivering results through efficient, well-executed designs. I am
            also passionate about learning new technologies and frameworks to
            stay ahead in this ever-evolving field.
          </p>

          <p className="text-xl mb-6 tracking-wide leading-relaxed opacity-80 transform transition-all duration-500 hover:scale-105 hover:text-teal-400">
            As an avid long-distance and trail runner, I apply the same
            determination and perseverance to my professional life. Every
            challenge is an opportunity to grow, and I thrive when pushing
            myself beyond limits.
          </p>
        </div>
        ...
        <div className="flex justify-center gap-8">
          <button className="px-6 py-3 bg-teal-600 text-white text-lg rounded-lg shadow-lg transition-all duration-300 transform hover:scale-110 hover:bg-teal-700 hover:shadow-xl">
            <a href="/article">Read My Articles</a>
          </button>
